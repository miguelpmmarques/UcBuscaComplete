        ...
        <div class="container-fluid">
            ...
            <c:choose>
                    ...
                    <ul class=" navbar-right nav navbar-nav ">
                        <c:choose>
                            <c:when test="${session.admin == true}">
                                <li class="nav-item">
                                    <a class="nav-link text-dark myTeamNav"
                                       href='<s:url action="manageusers" ></s:url>'> <b>Manage users</b> </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-dark myTeamNav" href='<s:url action="systeminfo" ></s:url>'>
                                        <b>System info</b> </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-dark myTeamNav" href='<s:url action="showAddurl" ></s:url>'>
                                        <b>Add url to UcBusca</b> </a>
                                </li>
                            </c:when>
                        </c:choose>
                        <c:choose>
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white myTeamNav" href='<s:url action="logout" ></s:url>'> <b>
                                Logout</b> </a>
                        </li>
                    </ul>
                </c:when>
                <c:otherwise>
                    ...
                    <ul class=" navbar-right nav navbar-nav ">
                        <li class="nav-item">
                            <a class="nav-link text-white myTeamNav" href='<s:url action="showLogin" ></s:url>'> <b>Login </b>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white myTeamNav" href='<s:url action="showRegister" ></s:url>'> <b>
                                Register</b> </a>
                        </li>
                    </ul>
                </c:otherwise>
