    ...
    <div class="card bg-warning col-6 mx-auto text-center">
        <div class="col-12 text-center">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <button class="btn btn-block btn-social btn-facebook" style="background-color:#007bff;" id="signin_facebook">
                        <i class="fab fa-facebook-f pt-2" style="color:#fff"></i> Sign up with Facebook
                    </button>
                </div>
                <div class="col-md-4"></div>
            </div>
